...
HttpServer.prototype.isREST_ = function(urlString) {
    var parsed  = url.parse(urlString);
    return (parsed.pathname.substring(0, 6) === '/rest/' && INTEGRATION);
};
...
HttpServer.prototype.handleRequest_ = function(req, res) {
    ...
    var isREST = this.isREST_(req.url);
    if(isREST){
